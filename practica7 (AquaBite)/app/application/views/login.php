...
<div class="container login-container">
    <div class="login-form">
        ...
        <form id="loginForm" action="<?php echo site_url('home_admin'); ?>" method="post">
            <div class="mb-3">
                <input type="text" class="form-control" placeholder="Email o usuario" name="username">
            </div>
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <small>¿Aún no tienes cuenta? <a href="<?php echo site_url('registro'); ?>" class="text-decoration-none">Regístrate</a></small>
        </div>
    </div>
</div>
...
<script>
    // JavaScript para manejar la redirección después del envío del formulario
    document.getElementById('loginForm').addEventListener('submit', function(event) {
        event.preventDefault(); // Prevenir el envío estándar del formulario
        // Redirigir a la página deseada
        window.location.href = '<?php echo site_url('home_admin'); ?>';
    });
</script>
</body>
</html>
